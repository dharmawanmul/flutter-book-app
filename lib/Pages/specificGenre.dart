...
class SpecificGenre extends StatelessWidget {
  const SpecificGenre({@required this.genre});
  final String genre;
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GenreBooks(genre),
    );
  }
}

class GenreBooks extends StatelessWidget {
    ...
    return Container(
        ...
        child: ListView.builder(
            ...
            itemBuilder: (BuildContext context, int i) {
              ...
              if (booklist.books[i].genre == genre && (booklist.books[i].show || booklist.books[i].show != true)) {
                return ShowGenre(
